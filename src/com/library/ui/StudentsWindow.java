...
public class StudentsWindow extends JFrame {
    ...
    public StudentsWindow() {
        ...
        RoundedButton addButton = new RoundedButton("Add Student");
        ...
        table.getColumnModel().getColumn(3).setCellRenderer(new ButtonRendererEditor("Edit", e -> editStudent(Integer.parseInt(e.getActionCommand()))));
        table.getColumnModel().getColumn(3).setCellEditor(new ButtonRendererEditor("Edit", e -> editStudent(Integer.parseInt(e.getActionCommand()))));
        table.getColumnModel().getColumn(4).setCellRenderer(new ButtonRendererEditor("Delete", e -> deleteStudent(Integer.parseInt(e.getActionCommand()))));
        table.getColumnModel().getColumn(4).setCellEditor(new ButtonRendererEditor("Delete", e -> deleteStudent(Integer.parseInt(e.getActionCommand()))));
